...
<style>
 body { font-family: "Yu Gothic", sans-serif; margin: 24px; max-width: 900px; }
 h1 { font-size: 1.2em; } h2 { font-size: 1.05em; margin-top: 1.4em; }
 .field { margin: 10px 0; padding: 8px 10px; border: 1px solid #ccc; border-radius: 6px; }
 .flabel { font-weight: bold; margin-bottom: 4px; }
 .opt { margin-right: 16px; white-space: nowrap; }
 table { border-collapse: collapse; margin-top: 8px; }
 td, th { border: 1px solid #999; padding: 4px 10px; text-align: center; }
 .hit { background: #e6f4e6; } .miss { background: #f8e6e6; }
 textarea { width: 100%; height: 180px; font-family: monospace; }
 .note { color: #555; font-size: 0.9em; }
 button { padding: 6px 14px; margin: 6px 4px 6px 0; }
</style></head><body>
