...
# boot_pilot.py の関数（run_2t, generate, ARMS, SCEN, INST 等）が同一セッションに
# 定義済みであることを前提とする。
...
# --- 探索版本実施: 4腕×N2×30(記述) ＋ GL第一パス×30 ---
print("\n== 本実施（探索・記述・分岐C確定・p値なし）==")
run_2t(["A5p2T", "GH", "GHnull", "GS"], 30, "trials-addd-main-Qwen3-30B-A3B-Instruct-2507")
run_2t(["GL1"], 30, "trials-addd-gl-firstpass-Qwen3-30B-A3B-Instruct-2507")
