...
MAX_NEW = {"N": 4096, "W": 12288, "P": 12288}  # N=4096は凍結追記②（2026-08-04・登録者承認）——
# 追補C/D/Eと同一値へ是正。①のN:1024はG-N第一走で5/6切断（A2-on-full土台の儀式構造が1024で収まらない
# ——E実測p50≈1,989字と矛盾する草稿値だった。過失の記帳は凍結追記②）。W/P=12288は①のまま。
